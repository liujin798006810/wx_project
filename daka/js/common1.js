!function (e, t) {
    ...
    var r, i = e.document, o = i.documentElement, a = i.querySelector('meta[name="viewport"]'),
        s = i.querySelector('meta[name="flexible"]'), u = 0, l = 0, c = t.flexible || (t.flexible = {});
    if (a) {
    ...
    if (!u && !l) {
        var g = (e.navigator.appVersion.match(/android/gi), e.navigator.appVersion.match(/iphone/gi)),
    ...
    function m(e, t) {
        for (var n, r, i = [], o = 0,
                 a = e.length; o < a; o++)r = e[o], r.style && (n = r.style.display, t ? ("none" === n && (i[o] = Oe.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && Be(r) && (i[o] = g(r))) : "none" !== n && (i[o] = "none", Oe.set(r, "display", n)));
    ...
    function x(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0,
                 h = e.length; d < h; d++)if (o = e[d], o || 0 === o)if ("object" === he.type(o)) he.merge(p, o.nodeType ? [o] : o); else if (Ye.test(o)) {
    ...
    function A(e, t, n) {
        for (var r, i = t ? he.filter(t, e) : e,
                 o = 0; null != (r = i[o]); o++)n || 1 !== r.nodeType || he.cleanData(v(r)), r.parentNode && (n && he.contains(r.ownerDocument, r) && y(v(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    ...
    function $(e, t, n) {
        for (var r, i = (z.tweeners[t] || []).concat(z.tweeners["*"]), o = 0,
                 a = i.length; o < a; o++)if (r = i[o].call(n, t, e))return r
    }

    function B(e, t, n) {
        var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
            g = e.nodeType && Be(e), v = Oe.get(e, "fxshow");
    ...
    function z(e, t, n) {
        var r, i, o = 0, a = z.prefilters.length, s = he.Deferred().always(function () {
            ...
            if (i)return !1;
            for (var t = dt || I(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r,
    ...
    var xe = function (e) {
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                var c, f, p, d = 0, h = "0", g = r && [], m = [], y = D, x = r || o && C.find.TAG("*", l),
        ...
        var w, T, C, E, k, S, N, j, D, A, q, L, F, H, O, P, R, M, I, W = "sizzle" + 1 * new Date, $ = e.document, B = 0,
    ...
    var Ie = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, We = new RegExp("^(?:([+-])=|)(" + Ie + ")([a-z%]*)$", "i"),
        $e = ["Top", "Right", "Bottom", "Left"], Be = function (e, t) {
    ...
    var Qe = te.documentElement, Je = /^key/, Ke = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Ze = /^([^.]*)(?:\.(.+)|)/;
    he.event = {
        global: {}, add: function (e, t, n, r, i) {
            ...
            var t, n, r, i, o, a, s = he.event.fix(e), u = new Array(arguments.length),
                l = (Oe.get(this, "events") || {})[s.type] || [], c = he.event.special[s.type] || {};
    ...
    he.extend({
        ...
        detach: function (e) {
            ...
            for (var e,
                     t = 0; null != (e = this[t]); t++)1 === e.nodeType && (he.cleanData(v(e, !1)), e.textContent = "");
            return this
        }, clone: function (e, t) {
        ...
        he.fn[e] = function (e) {
            for (var n, r = [], i = he(e), o = i.length - 1,
                     a = 0; a <= o; a++)n = a === o ? this : this.clone(!0), he(i[a])[t](n), oe.apply(r, n.get());
    ...
    he.extend({
        ...
        he.cssHooks[e + t] = {
            expand: function (n) {
                for (var r = 0, i = {},
                         o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++)i[e + $e[r] + t] = o[r] || o[r - 2] || o[0];
                return i
            }
    ...
    he.Animation = he.extend(z, {
        tweeners: {
            ...
            for (var n, r = 0,
                     i = e.length; r < i; r++)n = e[r], z.tweeners[n] = z.tweeners[n] || [], z.tweeners[n].unshift(t)
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = Oe.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = he.timers,
                    a = r ? r.length : 0;
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    ...
                    for (var n, r, i = e.options, o = he.makeArray(t),
                             a = i.length; a--;)r = i[a], (r.selected = he.inArray(he.valHooks.option.get(r), o) > -1) && (n = !0);
    ...
    var At = /%20/g, qt = /#.*$/, Lt = /([?&])_=[^&]*/, Ft = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ot = /^(?:GET|HEAD)$/, Pt = /^\/\//, Rt = {},
...
//coursemangement
window.url = url;
//window.href="http://www.1sedu.com/yishengjiaoyu/html/jiaoshi";

//教师中心 我的主页
var TEACHERHOMEHTML = 'yishengjiaoyu/html/jiaoshi/my_homepage.html';
//教师中心
var TEACHER = 'yishengjiaoyu/html/jiaoshi/teacher_center.html';
//生源大厅
...
//个人信息 地址 姓名 二维码
var EDITINFORMATION = 'yishengjiaoyu/html/information/bianjiInformation.html';
//个人信息 账户中心
var PERSONALINFORMATION = 'yishengjiaoyu/html/information/zhanghuxinxi.html';
...
//全局URL
function href() {
    var location = 'http://www.1sedu.com/lifetime/';
    return location;
}
//页面跳转URL
...
//当圈子话题没有图片时隐藏图片标识
function hideImg(pImg) {
    if (pImg.attr('src') == null || pImg.attr('src') == 'undefined' || pImg.attr('src') == '') {
        pImg.parent().hide();
    }
}
...
function alertMsg(str) {
    ...
    $('<div class="popupMsg"><p class="alert_msg">' + str + '</p><p class="yes">确定</p></div></div>').appendTo("body");
...
function getPage(method) {
    $(window).scroll(function () {
        ...
        var scrollHeight = $(document).height();//可视区域的高度 + 滚动的距离

        if (windowHeight + scrollTop >= scrollHeight && scrollTop != 0) {
...
// 添加loading图
function addLoading() {
    $('.e-hts-list').append('<div class="img-loading"></div>');
}
