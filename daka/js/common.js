...
//话题列表video控制
function hideV(videoH){
    return videoH.css('width', '100%');
}

//屏蔽话题列表a链接
function hideA(aHref){
    aHref.parent().find('img').css('width', '0.37rem');
    aHref.attr('href', 'javascript:;').css('fontSize', '0.37rem');
}
